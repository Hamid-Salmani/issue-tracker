  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-10">
      ...
      <div className="flex items-center justify-between gap-4">
        <Heading size="4" className="text-gray-900 text-3xl font-bold tracking-tight leading-snug">
          {issue.title}
        </Heading>

        <div className="flex justify-end gap-2 w-full">
          <Link href="/issues">
            <Button variant="soft" color="gray" className="rounded-xl shadow-sm !cursor-pointer">
              ← Back
            </Button>
          </Link>
          <Link href={`/issues/${issue.id}/edit`}>
            <Button variant="soft" color="blue" className="rounded-xl shadow-sm !cursor-pointer">
              ✏️ Edit
            </Button>
          </Link>
        ...
        <Flex className="flex-wrap gap-3 items-center">
          ...
          <Text className="text-gray-600 text-sm">{issue.createdAt.toDateString()}</Text>
